...
import com.example.dukkanexpress.accountFragments.AccountInfo;
import com.example.dukkanexpress.accountFragments.ChangePassword;
import com.example.dukkanexpress.accountFragments.PreviousOrder;
...
public class User extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (!Paper.book("dukkan").contains("current_user"))
            ...
            Common.currentUser = Paper.book("dukkan").read("current_user");
    ...
    public void logout() {
        ...
        Paper.book("dukkan").delete("current_user");
